...
| Capítulo | Título | Archivo |
|---|---|---|
| 1 | Presentando la Orange Pi 5 Plus | [cap01_presentacion.md](cap01_presentacion.md) |
| 2 | Puesta en marcha y primer contacto | [cap02_puesta_en_marcha.md](cap02_puesta_en_marcha.md) |
| 3 | Dominando Linux para la Orange Pi | [cap03_linux.md](cap03_linux.md) |
| 4 | El entorno de desarrollo en Python | [cap04_python.md](cap04_python.md) |

## PARTE 2 — Conquistando el Hardware
*Nivel: Intermedio. Requiere haber completado la Parte 1.*

| Capítulo | Título | Archivo | Código |
|---|---|---|---|
| 5 | El corazón de la electrónica: GPIO | [cap05_gpio.md](cap05_gpio.md) | `01_gpio_salida.py` · `02_gpio_entrada.py` |
| 6 | Comunicación con el mundo: I2C, SPI y PWM | [cap06_comunicacion.md](cap06_comunicacion.md) | `03_pwm_servo.py` · `04_i2c_escaneo.py` · `05_i2c_oled.py` · `06_spi_loopback.py` |
| 7 | Los componentes integrados de la placa | [cap07_integrados.md](cap07_integrados.md) | `07_leds_integrados.py` |
...
| Capítulo | Título | Archivo |
|---|---|---|
| 8 | Compilación cruzada y el bootloader | [cap08_compilacion.md](cap08_compilacion.md) |
| 9 | Creando tu propio sistema con Buildroot | [cap09_buildroot.md](cap09_buildroot.md) |
| 10 | Programación a bajo nivel: demonios y señales | [cap10_bajo_nivel.md](cap10_bajo_nivel.md) |
| 11 | El mundo de los drivers de dispositivo | [cap11_drivers.md](cap11_drivers.md) |
...
| Capítulo | Título | Archivo | Código |
|---|---|---|---|
| 12 | Inteligencia artificial en el edge con la NPU | [cap12_npu.md](cap12_npu.md) | `08_npu_inferencia.py` |
| 13 | Proyectos finales integradores | [cap13_proyectos.md](cap13_proyectos.md) | — |
